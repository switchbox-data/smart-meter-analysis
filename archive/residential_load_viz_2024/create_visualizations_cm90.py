#!/usr/bin/env python
"""
Professional visualizations using CM90 (quality-filtered) data.
"""
...
def create_monthly_heatmap_cm90(data_path: str, output_path: str = "heatmap_cm90.png"):
    """Create professional seaborn heatmap from CM90 data."""
    ...
    sns.heatmap(
        ...
        cmap="RdYlBu_r",
        cbar_kws={
            "label": f"Total Energy Consumption (kWh)\n~{n_customers:,} Quality-Filtered Households",
            "shrink": 0.75,
            "pad": 0.02,
            "aspect": 30,
        },
    ...
    ax.set_title(
        f"Residential Electricity Load Patterns (CM90 Quality-Filtered)\n"
        f"Chicago ZIP 60622 • {date_range} • {n_customers:,} Households\n"
        f"Natural Gas Heating | Electric Air Conditioning",
        fontsize=17,
        fontweight="bold",
        pad=25,
    )
...
def create_hourly_profile_cm90(data_path: str, output_path: str = "hourly_profile_cm90.png"):
    """Create hourly profile from CM90 data."""
    print("\n📊 Creating CM90 hourly profile...")
    ...
    ax.set_title(
        f"Average Hourly Electricity Usage (CM90 Quality-Filtered)\n"
        f"{n_customers:,} Chicago Households • June 2024 - June 2025",
        fontsize=17,
        fontweight="bold",
        pad=25,
    )
...
def create_weekend_comparison_cm90(data_path: str, output_path: str = "weekend_comparison_cm90.png"):
    """Compare weekday vs weekend from CM90 data."""
    print("\n📊 Creating CM90 weekend comparison...")
    ...
    ax.set_title(
        "Weekday vs Weekend Load Profiles (CM90 Quality-Filtered)\nTemporal Consumption Patterns",
        fontsize=17,
        fontweight="bold",
        pad=25,
    )
...
if __name__ == "__main__":
    print("=" * 80)
    print("CM90 QUALITY-FILTERED VISUALIZATIONS")
    print("=" * 80)
    ...
    create_monthly_heatmap_cm90(data_file, "residential_heatmap_cm90.png")
    create_hourly_profile_cm90(data_file, "residential_hourly_cm90.png")
    create_weekend_comparison_cm90(data_file, "residential_weekend_cm90.png")

    print("\n" + "=" * 80)
    print("✅ CM90 VISUALIZATIONS COMPLETE!")
    print("=" * 80)
    print("\nGenerated files:")
    print("  📈 residential_heatmap_cm90.png")
    print("  📈 residential_hourly_cm90.png")
    print("  📈 residential_weekend_cm90.png")
    print("\nNote: These use quality-filtered data (≥90% valid days)")
    print("=" * 80)
