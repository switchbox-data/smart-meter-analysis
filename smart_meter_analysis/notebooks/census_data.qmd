...
def build_geoid(df: pl.DataFrame) -> pl.DataFrame:
    return df.with_columns(
        pl.concat_str([
            ...
            pl.col("block_group).cast(pl.Utf8).str.zfill(1)
        ]).alias("GEOID")
    )

# Prevent division with zeroes
...
# Avoid Census codes for unavailable data
