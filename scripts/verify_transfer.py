...
def verify_transfer():
    ...
    s3_files = set()
    for page in paginator.paginate(Bucket="smart-meter-data-in-us-west-2", Prefix="ComEd/"):
...
if __name__ == "__main__":
    ...
    if all_good:
        ...
        console.print("[yellow]⚠ Some files need retry - run retry_failures.py[/yellow]")
