...
def get_files_via_api():
    ...
    # SharePoint REST endpoint for folder contents
    api_url = f"{BASE_URL}/_api/web/GetFolderByServerRelativeUrl('{quote(TARGET_FOLDER)}')/Files"
